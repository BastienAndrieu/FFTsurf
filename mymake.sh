...
echo "...compare_bern_cheb.out"
gfortran -Wall -Wextra -fbounds-check -g -c -Iobj/ test/src/compare_bern_cheb.f90 -o test/obj/compare_bern_cheb.o
gfortran -Wall -Wextra -fbacktrace -fbounds-check -g -o test/compare_bern_cheb.out test/obj/compare_bern_cheb.o obj/mod_util.o obj/mod_math.o obj/mod_linalg.o obj/mod_chebyshev.o obj/mod_bernstein.o obj/mod_polynomial.o obj/mod_tolerances.o obj/mod_obb.o -Lsrc/dfftpack -ldfftpack
