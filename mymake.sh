...
gfortran -Wall -Wextra -fbacktrace -fbounds-check -g -o test/pre_intersection.out test/obj/pre_intersection.o obj/mod_util.o obj/mod_constants.o obj/mod_math.o obj/mod_chebyshev.o obj/mod_bernstein.o obj/mod_diffgeom.o obj/mod_obb.o obj/mod_errors_intersection.o obj/mod_linearprogramming.o obj/mod_geometry.o obj/mod_separation.o obj/mod_tolerances.o -Lsrc/dfftpack -ldfftpack -Lobj/intersection -lintersection
...
gfortran -Wall -Wextra -fbacktrace -fbounds-check -g -o test/complexite_fcht.out test/obj/complexite_fcht.o obj/mod_util.o obj/mod_constants.o obj/mod_math.o obj/mod_chebyshev.o -Lsrc/dfftpack -ldfftpack
...
gfortran -Wall -Wextra -fbacktrace -fbounds-check -g -o test/decasteljau.out test/obj/decasteljau.o obj/mod_util.o obj/mod_constants.o obj/mod_math.o obj/mod_bernstein.o obj/mod_obb.o


gfortran -Wall -Wextra -fbounds-check -g -c -Iobj/ test/src/pre_intersection_bezier.f90 -o test/obj/pre_intersection_bezier.o
gfortran -Wall -Wextra -fbacktrace -fbounds-check -g -o test/pre_intersection_bezier.out test/obj/pre_intersection_bezier.o obj/mod_util.o obj/mod_constants.o obj/mod_math.o obj/mod_chebyshev.o obj/mod_bernstein.o obj/mod_diffgeom.o obj/mod_obb.o obj/mod_errors_intersection.o obj/mod_linearprogramming.o obj/mod_geometry.o obj/mod_separation.o -Lsrc/dfftpack -ldfftpack -Lobj/intersection -lintersection


gfortran -Wall -Wextra -fbounds-check -g -c -Iobj/ test/src/subdiv2_bezier.f90 -o test/obj/subdiv2_bezier.o
gfortran -Wall -Wextra -fbacktrace -fbounds-check -g -o test/subdiv2_bezier.out test/obj/subdiv2_bezier.o obj/mod_util.o obj/mod_constants.o obj/mod_math.o obj/mod_chebyshev.o obj/mod_bernstein.o obj/mod_obb.o -Lsrc/dfftpack -ldfftpack
...
gfortran -pg -Wall -Wextra -fbacktrace -fbounds-check -g -o test/dev_intersection_simple_surface.out test/obj/dev_intersection_simple_surface.o obj/mod_util.o obj/mod_constants.o obj/mod_math.o obj/mod_chebyshev.o obj/mod_bernstein.o obj/mod_diffgeom.o obj/mod_linearprogramming.o obj/mod_geometry.o obj/mod_separation.o obj/mod_obb.o obj/mod_tolerances.o -Lsrc/dfftpack -ldfftpack

gfortran -Wall -Wextra -fbounds-check -g -c -Iobj/ test/src/perfo_subdivision.f90 -o test/obj/perfo_subdivision.o
gfortran -Wall -Wextra -fbacktrace -fbounds-check -g -o test/perfo_subdivision.out test/obj/perfo_subdivision.o obj/mod_util.o obj/mod_constants.o obj/mod_math.o obj/mod_chebyshev.o obj/mod_bernstein.o -Lsrc/dfftpack -ldfftpack



gfortran -Wall -Wextra -fbounds-check -g -c -Iobj/ test/src/tree.f90 -o test/obj/tree.o
gfortran -Wall -Wextra -fbacktrace -fbounds-check -g -o test/tree.out test/obj/tree.o obj/mod_constants.o obj/mod_util.o obj/mod_math.o obj/mod_obb.o obj/mod_chebyshev2.o obj/mod_bernstein2.o obj/mod_polynomial.o obj/mod_regiontree.o -Lsrc/dfftpack -ldfftpack
