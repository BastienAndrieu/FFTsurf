...
# 1: cas
# 2: fps
# 3: duree premiere image (s)
# 4: duree derniere image (s)
# 5: nom fichier film
...
cmd = "-ovc lavc -lavcopts vcodec=msmpeg4v2:vpass=1:vbitrate=32000000:mbd=2:keyint=132:vqblur=1.0:cmp=2:subcmp=2:dia=2:last_pred=3 -mf type=jpg:fps="+str(fps)+" -vf scale="+str(int(width))+":"+str(int(height))+" -nosound -o "
